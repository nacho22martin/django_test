...
SECRET_KEY = 'z10@7cyp4!rn0sc0bw=bd^(-sb@o8_o8qzg$3mge^12%(935^f'
...
CONTACT_FORM_CLASS = "catalogo.forms.ContactForm"
...
ROOT_URLCONF = 'augustorubio.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'augustorubio.wsgi.application'
